...
function Login({ setCurrentPage, isDarkMode, setIsDarkMode }) {
  const [role, setRole] = useState('nurse'); // 'nurse' or 'doctor'
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white dark:bg-gray-900 transition-colors duration-300">
      ...
      <div className="max-w-md w-full px-6 py-8">
        <h2 className="text-[32px] font-bold text-gray-900 dark:text-white mb-1">Sign in</h2>
        <p className="text-base text-gray-800 dark:text-gray-300 mb-6">
          or <a href="#" className="text-[#0d6efd] dark:text-blue-400 hover:underline">create an account</a>
        </p>
        ...
        <form onSubmit={handleSignIn} className="space-y-4">
          ...
          <div className="flex items-center pt-2">
            <input
              ...
              name="remember-me"
              type="checkbox"
              className="h-4 w-4 text-[#0d6efd] focus:ring-[#0d6efd] border-gray-400 rounded-sm dark:border-gray-600 dark:bg-gray-800"
            />
          ...
          <div className="pt-2 space-y-4">
            ...
            <button
              type="button"
              className="w-full py-3 px-4 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-800 dark:text-gray-200 font-medium focus:outline-none transition-colors flex items-center justify-center gap-3"
            >
